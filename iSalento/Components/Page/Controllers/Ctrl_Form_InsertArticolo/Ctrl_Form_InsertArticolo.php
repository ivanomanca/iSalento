 ...
 */		
class Ctrl_Form_InsertArticolo extends Isp_Controller_Action_Instantiator{
	
	public $linkForm = "index.php?component=Crud&task=insert&crudNtt=Articolo**Tea";
	public $ntt = null; // Nome entitˆ di provenienza
	public $idNtt = null;
	public $photoNtt = null; // Nome entitˆ di provenienza
	...
	public function loadForwardPages(){
		...
		if(isset($this->photoNtt)){
			$nextOkPage = $nextOkPage + array(	"photoNtt" => $this->photoNtt,
						 						"photoIdNtt" => $this->photoIdNtt);
		}

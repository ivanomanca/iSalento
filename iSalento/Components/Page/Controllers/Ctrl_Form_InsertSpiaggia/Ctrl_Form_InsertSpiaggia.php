 ...
 */		
class Ctrl_Form_InsertSpiaggia extends Isp_Controller_Action_Instantiator{
	public $linkForm = "index.php?component=Crud&task=insert&crudNtt=Struttura**Spiaggia";

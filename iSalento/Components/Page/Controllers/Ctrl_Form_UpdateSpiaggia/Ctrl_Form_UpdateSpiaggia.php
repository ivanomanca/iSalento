 ...
 */		
class Ctrl_Form_UpdateSpiaggia extends Isp_Controller_Action_Instantiator{
	public $linkForm = "index.php?component=Crud&task=update&crudNtt=Struttura**Spiaggia&id_struttura=";
							
	public function init($pag=null){
		// Manage Urls
		Isp_Loader::loadClass("Isp_Url");
		$this->linkForm.=$pag->paramsArray['id_struttura'];
